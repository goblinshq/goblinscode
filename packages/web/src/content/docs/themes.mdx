...
:::tip Theme preview (Desktop)
In the Desktop app, the theme picker previews the highlighted theme (and the `light`/`dark`/`system` scheme) as you move through the list. Press `Enter` to apply, or `Esc` to cancel and restore your previous theme.
:::
