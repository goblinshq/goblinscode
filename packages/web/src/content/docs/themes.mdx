...
The desktop app uses UI themes (separate from terminal themes) and lets you switch them from the Command Palette.

- **Open Command Palette**: `Ctrl/Cmd+Shift+P`
- **Cycle theme**: `Ctrl/Cmd+Shift+T`
- **Cycle color scheme** (System → Light → Dark): `Ctrl/Cmd+Shift+S`

From the Command Palette, search for "Theme" to find actions like:

- "Cycle theme"
- "Cycle color scheme"
- "Use theme: …" (select a specific theme)

Built-in desktop themes currently include: `oc-1`, `tokyonight`, `dracula`, `monokai`, `solarized`, `nord`, `catppuccin`, `ayu`, `onedarkpro`, `shadesofpurple`.
